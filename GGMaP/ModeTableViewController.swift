...
protocol modeprotocol:class {
    func modeType(_ mode:String)
}

class ModeTableViewController: UITableViewController {
    
    weak var modeDelegate:modeprotocol?
    
     let modeValue = ["walking", "driving", "cycling"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
      ...
      cell.textLabel?.text = modeValue[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if modeDelegate != nil{
             let value = modeValue[indexPath.row]
           modeDelegate?.modeType(value)
